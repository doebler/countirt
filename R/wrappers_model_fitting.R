#' Model fitting function for count data IRT models. Please read Details below.
#' 
...
cirt <- function(model, data, family,
  ...
  if (any(model_list$item_data < 0)) {
    stop("Responses must be non-negative counts.")
  }
