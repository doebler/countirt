...
NumericVector grad_cmp_with_icov_all_cpp(double alpha,
  ...
  NumericVector out(3 + I_alpha + I_delta + I_logdisp);
  ...
  for(int c=0; c<I_logdisp; c++) {
    out[3 + c + I_alpha + I_delta] = grad_betas_logdisp[c];
  }
...
// [[Rcpp::export]]
NumericVector grad_cmp_fixdisps_samealpha_cpp(NumericVector alphas,
                                          NumericVector deltas,
                                          NumericVector disps,
                                          NumericVector item_offset,
                                          NumericMatrix data,
...
// [[Rcpp::export]]
NumericVector grad_cmp_fixdisps_samealpha_poff_cpp(NumericVector alphas,
                                         NumericVector deltas,
                                         NumericVector disps,
                                         NumericVector item_offset,
                                         NumericVector person_offset,
